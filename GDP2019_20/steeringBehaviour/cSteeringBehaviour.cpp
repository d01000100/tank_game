...
glm::vec3 seekBhvr(glm::vec3 vehiclePosition,
...
glm::vec3 fleeBhvr(glm::vec3 vehiclePosition,
	glm::vec3 vehicleVelocity, glm::vec3 target,
	float deltaTime, float maxVelocity = 10.0f)
{
	glm::vec3 resultVelocity = vehicleVelocity;
...
glm::vec3 arriveBhvr(glm::vec3 vehiclePosition,
	glm::vec3 vehicleVelocity, glm::vec3 target,
	float deltaTime, float maxVelocity = 10.0f)
{
...
glm::vec3 wanderBhvr(glm::vec3 vehiclePosition,
